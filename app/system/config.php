...
define('DB_USER', 'cvics_app'); # Database Username
define('DB_PASSWORD', 'Ee;xWh$,=Y34)fs"'); # Database Password
define('DB_NAME', 'cvics_app'); # Database Name
define('APP_URL', 'https://cvics.org/app'); # Application URL.
