...
//');
        ...
        $departments = TicketDepartment::all()->keyBy('id')->all();
    ...
    case 'users-edit':
      ...
      //  $ui->assign('content_inner',inner_contents($config['c_cache']));
        ...
        if($d){
            ...
            $assigned_departments = Relation::where('type','staff_departments')->where('source_id',$id)->get()->keyBy('target_id')->all();
            ...
            if($user->roleid == '0')
            {
                ...
                if(isset($_POST['departments']))
                {
                    ...
                    foreach ($departments as $department)
                    {
                        ...
                        if(is_numeric($department) && TicketDepartment::find($department))
                        {
 ...
 ');
    ...
    case 'add_currency_post':
        ...
        if(strlen($iso_code) != 3){
            ...
            $msg .= 'Invalid Currency Code. Please use 3 digit ISO code for your currency. <br>';
